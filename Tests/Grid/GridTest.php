...
class GridTest extends TestCase
{
    ...
    public function testResetGridSessionWhenChangeGrid()
    {
        $row = $this->createMock(Row::class);
        $rows = new Rows();
        $rows->addRow($row);
    ...
    public function testResetGridSessionWhenResetFiltersIsPressed()
    {
        $row = $this->createMock(Row::class);
        $rows = new Rows();
        $rows->addRow($row);
    ...
    public function testNotResetGridSessionWhenXmlHttpRequest()
    {
        $row = $this->createMock(Row::class);
        $rows = new Rows();
        $rows->addRow($row);
    ...
    public function testNotResetGridSessionWhenPersistenceSetted()
    {
        $row = $this->createMock(Row::class);
        $rows = new Rows();
        $rows->addRow($row);
    ...
    public function testNotResetGridSessionWhenRefererIsSameGrid()
    {
        $scheme = 'http';
        $host = 'www.foo.com/';
        $basUrl = 'baseurl';
    ...
    public function testRaiseExceptionIfMassActionIdNotValid()
    {
        ...
        $this->grid->addMassAction($this->getMockBuilder(MassAction::class)->disableOriginalConstructor()->getMock());

        $this->grid->handleRequest($request);
    }

    public function testRaiseExceptionIfMassActionCallbackNotValid()
    {
    ...
    public function testResetPageAndLimitIfMassActionHandleAllData()
    {
        $row = $this->createMock(Row::class);
        $rows = new Rows();
        $rows->addRow($row);
...
//    public function testMassActionResponseFromCallback()
//    {
//        $row = $this->createMock(Row::class);
//        $rows = new Rows();
//        $rows->addRow($row);
...
//    public function testMassActionResponseFromControllerAction()
//    {
//        $row = $this->createMock(Row::class);
//        $rows = new Rows();
//        $rows->addRow($row);
...
//        $this->container->method('get')->with('http_kernel')->willReturn($httpKernel);
//
